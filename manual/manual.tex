...
\begin{document}
  ...
  - Attach the LeapMotion device using the provided USB cable
  - (install the LeapMotion SDK)
  - Start the LeapMotion program provided by the LeapMotion SDK to start
    tracking
  - (Install the Rust programming language)
  - Download/Install the Can't Touch This platform
  - Start up the Can't Touch This platform
  - Start up an internet browser and navigate to http://localhost:8000/
  - Click on 'Start recording' and make a motion above the LeapMotion sensor
  - Once you've made the motion you wanted, click on stop recording and save the
    gesture
  - Bind the motion you've just made to one of the predefined actions
  - Go into recognition mode and try to see if the computer executes the action
    you've bound your motion to
  \clearpage
  ...
  Sampling is the act of ... % TODO: Ask Tim for an explanation
