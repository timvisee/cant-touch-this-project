...
\begin{document}
  ...
  % TODO: how accurate is gesture detection
  % TODO: define a list of gestures to test
  % TODO: what gestures work, what gestures don't work (which are easy / hard)
  % TODO: what are our findings? (long gestures with sharp corners are often not
  % recognized) Why could this be the case?
  ...
  gestures. Improvements would mostly consist of software improvements rather
